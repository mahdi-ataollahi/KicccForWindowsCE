...
namespace System.Globalization
{
    ...
    internal class CalendricalCalculationsHelper
    {
        ...
        {
            return date.Ticks / PersianCalendar.TicksPerDay;
        }

        static int GetGregorianYear(double numberOfDays)
        {
            return new DateTime(Math.Min((long)(Math.Floor(numberOfDays) * PersianCalendar.TicksPerDay), DateTime.MaxValue.Ticks)).Year;
        }
